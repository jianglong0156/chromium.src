...
#import "chrome/browser/ui/cocoa/toolbar/devtool_button_cocoa.h"
...
- (void)awakeFromNib {
  ...
  [self updateTag:IDC_SHOW_DEVTOOL];
  //[self populateMenu];
}
...
- (void)updateTag:(NSInteger)anInt {
  ...
  id cell = [self cell];
  [self setTag:anInt];
  [cell setImageID:IDR_SHOW_DEVTOOL
    forButtonState:image_button_cell::kDefaultState];
  [cell setImageID:IDR_SHOW_DEVTOOL_H
    forButtonState:image_button_cell::kHoverState];
  [cell setImageID:IDR_SHOW_DEVTOOL_P
...
- (void)executeMenuItem:(id)sender {
  ...
  commandUpdater_->ExecuteCommandWithDisposition(IDC_SHOW_DEVTOOL, ui::DispositionFromEventFlags(event_flags));
}

@end  // DevtoolButton

@implementation DevtoolButton (Testing)

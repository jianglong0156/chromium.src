...
void recordUserData(int id)
{
    ...
    std::string systemVersionStr = base::SysInfo::OperatingSystemVersion();
    ...
    case IDC_SHOW_DEVTOOL:
      {
        ...
        recordUserData(IDC_RECORD_APP_CLICK_CDT);
      } 
      break;
      //20150721 add by leo
